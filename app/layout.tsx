  ...
  return (
    <html lang="cz" suppressHydrationWarning>
      <Head>
        ...
        <meta
          name="description"
          content="Portfolio of Aleš Kruba, a full-stack web developer specializing in frontend and backend development using JavaScript, React, Next.js, and Express.js."
        />
        <meta name="author" content="Aleš Kruba" />
        <meta
          name="keywords"
          content="Portfolio, Full Stack Web Development, JavaScript, TypeScript, React js, Next js, Express js, Tailwind CSS, Material UI, Docker, Databases, PHP, Python"
        />

        <meta
          property="og:title"
          content="Aleš Kruba - Full Stack Web Developer Portfolio"
        />
        <meta
          property="og:description"
          content="Explore the portfolio of Aleš Kruba, showcasing my skills in frontend and backend web development, including React, Next.js, Express.js, and more. Projects and experiences displayed in a dynamic, user-friendly format."
        />
